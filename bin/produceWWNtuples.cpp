...
vector<double> generate_weights(TH1* data_npu_estimated, int isForSynch){
  // see SimGeneral/MixingModule/python/mix_2015_25ns_FallMC_matchData_PoissonOOTPU_cfi.py; copy and paste from there:
  const double npu_probs[50] = { 0.000108643, 0.000388957, 0.000332882, 0.00038397,  0.000549167,
