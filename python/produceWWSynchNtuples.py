...
if __name__ == '__main__':
    ...
    parser.add_argument ('-o', '--output' , default = 'RSGraviton1000Synch.root', help='output file')
    ...
    parser.add_argument ('-n', '--name' , default = 'ReducedSelection_RSGraviton1000.root' , help='input file')
    ...
    print 'produceWWSynchNtuples '+args.inputFolder+' '+args.output+' '+args.ismc+' '+args.lepton+' '+args.tree+' '+args.name+' '+args.xsecWeight+' '+args.numberOfEntries
    os.system('./produceWWSynchNtuples.exe '+args.inputFolder+' '+args.output+' '+args.ismc+' '+args.lepton+' '+args.tree+' '+args.name+' '+args.xsecWeight+' '+args.numberOfEntries)
