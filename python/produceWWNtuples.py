...
if __name__ == '__main__':
    ...
    parser.add_argument ('-o', '--output' , default = 'sch.root', help='output file')
    ...
    parser.add_argument ('-n', '--name' , default = 'ReducedSelection_sch.root' , help='input file')
    parser.add_argument ('-w', '--xsecWeight' , default = '7.2' , help='xsec (pb)')
    parser.add_argument ('-no', '--numberOfEntries' , default = '499999' , help='number of initial entries of the dataset')
