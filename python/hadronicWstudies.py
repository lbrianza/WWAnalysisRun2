...
if __name__ == '__main__':
    ...
    print 'hadronicWstudies.exe '+args.inputFolder+' '+args.output+' '+args.lepton+' '+args.name
    os.system('./hadronicWstudies.exe '+args.inputFolder+' '+args.output+' '+args.lepton+' '+args.name)
